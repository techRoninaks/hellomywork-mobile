...
public class ManageEmployeesFragment extends Fragment {
    ...
    private WebView webViewManageEmployees;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webViewManageEmployees = rootview.findViewById(R.id.webview_customer_manage);
        webViewManageEmployees.setWebViewClient(new WebViewClient());
        WebSettings webSettings = webViewManageEmployees.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webViewManageEmployees.loadUrl("https://www.hellomywork.com/admin/employee.html");
